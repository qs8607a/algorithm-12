...
public:
	static CppUnit::TestSuite * suite() {
		...
		suiteOfTests->addTest(new CppUnit::TestCaller<HeapTestCase>("test_add", &HeapTestCase::test_add));
		return suiteOfTests;
	}
	...
	void test_add() {
		...
		for(std::vector<int>::iterator i=randomInt.begin();i!=randomInt.end();++i){
			h.add(*i);
		}
